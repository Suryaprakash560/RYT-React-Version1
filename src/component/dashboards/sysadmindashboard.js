...
export default function SysAdminDashboard () {
    return(
        <div className="Inner_Contaner">
            ...
            <div className="row">
                <div className="col-12 col-sm-12 col-lg-4 col-md-4 col-xl-4">
                    <div className="row">
                ...
                <div className="col-12 col-sm-12 col-lg-8 col-md-8 col-xl-8">
                    ...
                    <div className="Inside-Content-container dark-mode d-flex">
                        <div className=" col-12 col-sm-12 col-lg-5 col-md- col-lg-5 ms-1 me-2">
                            <div className="content-div h-100">
